    ...
    <div style={{ display: "flex", flexDirection: "column", gap: "1.2rem" }}>
      <label style={{ display: "flex", flexDirection: "column", gap: "0.45rem" }}>
        ...
        <input
          ...
          placeholder="e.g. Bryant, or Cleveland, or OH"
          style={{
      ...
      {loading && <p style={{ color: "var(--ink-3)" }}>Loading facility data…</p>}
      {err && (
              ...
              {hits.map((r) => {
                ...
                return (
                  <tr key={String(r[IDX.ccn])}>
                    ...
                    <td>
                      <WeekShape
                        values={[4, 5, 6, 7, 8, 9, 10].map((i) => r[i] as number | null)}
                      />
                    </td>
                    ...
                    <td className="mono tnum">{r[IDX.star] ?? "—"}</td>
                  </tr>
                );
              })}
            </tbody>
